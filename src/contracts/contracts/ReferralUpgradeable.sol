    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        _defaultReferrer = payable(0x7a0DeC713157f4289E112f5B8785C4Ae8B298F7F);
        _levelDecimals = 1000;
        _levelRateReferral = [50,10,10,10,10,10,10,10,10,10,10];
        _levelRateStaking = [10,10,10,10,10,10,10,10,10,10,10];
        _circularReferenceLevels = 11;
    ...
    function _payReferralStaking(uint256 value, address _referee, address _payReferralInStakingContract) private {
        ...
        for (uint256 i; i < _levelRateStaking.length; i++) {
            ...
            _transferTokensFrom(_payReferralInStakingContract, _tokenSeller, referrer, c);
